...
export default $config({
  ...
  async run() {
    ...
    const api = new sst.aws.Function("ApiFunction", {
      ...
      permissions: [
        {
          actions: ["bedrock:Converse", "bedrock:InvokeModel", "bedrock:InvokeModelWithResponseStream"],
          resources: [
        ...
        },
        {
          ...
          resources: [`arn:aws:logs:*:*:log-group:/aws/lambda/sst-python-ai-api-${$app.stage}-ApiFunction*`],
        },
      ],
    });
