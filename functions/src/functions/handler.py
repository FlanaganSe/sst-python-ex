...
def handle_health(context: LambdaContext) -> dict[str, Any]:
...
def handle_echo(request_data: dict[str, Any]) -> dict[str, Any]:
    ...
    return make_response(200, {"echo": request_data, "received_at": datetime.utcnow().isoformat()})
...
def handle_fetch() -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("Fetch error", exc_info=e)
...
def handle_ai_query(request_data: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("AI service error", exc_info=e)
